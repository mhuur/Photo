...
- [ ] **Phase 7 — Cleanup** : convergence des derniers boutons néon, glyphes unicode résiduels (`▴▾` du tri Clients, `＋` de l'éditeur CGV, `↶` du toast Undo), styles morts, archivage de la maquette. **Le voile peut descendre vers `.75`** maintenant que toutes les vues sont en panneaux.
